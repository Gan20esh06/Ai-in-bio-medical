...
export default function Processing() {
  ...
  useEffect(() => {
    ...
    let apiErrStep: string | null = null;
      ...
      >
        ...
        <div className="text-center space-y-4">
          ...
          <p className="text-muted-foreground text-sm max-w-md mx-auto">
            Processing multi-modal biometric data through the AI health
            prediction model
          </p>
        </div>
        ...
        {/* Error */}
        {error && (
          <div className="p-6 rounded-xl bg-destructive/10 text-destructive text-sm text-center space-y-4">
            ...
            <div className="flex justify-center gap-3">
              {errorStep === "face" && (
                <Button
                  ...
                  size="sm"
                  className="gap-2"
                  onClick={() => setLocationRef.current("/face-scan")}
                >
                  <RotateCcw className="w-4 h-4" /> Retake Face Scan
                </Button>
              )}
              {errorStep === "voice" && (
                <Button
                  ...
                  size="sm"
                  className="gap-2"
                  onClick={() => setLocationRef.current("/voice-scan")}
                >
                  <RotateCcw className="w-4 h-4" /> Retake Voice Scan
                </Button>
              )}
              {(!errorStep || errorStep === "prediction") && (
                <Button
                  variant="outline"
                  size="sm"
                  className="gap-2"
