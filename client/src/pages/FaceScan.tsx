  ...
  const startCamera = useCallback(async () => {
    try {
      ...
      if (videoRef.current) {
        ...
        setTimeout(
          () => setIndicators((prev) => ({ ...prev, faceCentered: true })),
          1400,
        );
        setTimeout(
          () =>
            setIndicators((prev) => ({ ...prev, lightingSufficient: true })),
          2000,
        );
        setTimeout(
          () => setIndicators((prev) => ({ ...prev, eyeVisibility: true })),
          2600,
        );
      }
    } catch {
    ...
    <div className="max-w-6xl mx-auto px-4 py-8">
      ...
      >
        ...
        <p className="text-muted-foreground max-w-lg mx-auto">
          Our AI analyzes facial landmarks, skin patterns, and micro-expressions
          to extract optical biomarkers.
        </p>
      </motion.div>
          ...
          >
            ...
            <div className="space-y-3">
              {[
                ...
                {
                  label: "Lighting Sufficient",
                  active: indicators.lightingSufficient,
                },
          ...
          >
            ...
            <div className="space-y-4">
              {[
                {
                  label: "Eye Stability",
                  value: biomarkers.eye,
                  color: "bg-blue-500",
                },
                {
                  label: "Facial Symmetry",
                  value: biomarkers.symmetry,
                  color: "bg-emerald-500",
                },
                {
                  label: "Fatigue Index",
                  value: biomarkers.fatigue,
                  color: "bg-amber-500",
                },
                {
                  label: "Skin Brightness",
                  value: biomarkers.brightness,
                  color: "bg-purple-500",
                },
              ].map((m, i) => (
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
            {capturedImage ? (
              <Button
                variant="outline"
                className="h-12 bg-white col-span-2 md:col-span-1"
                onClick={retake}
              >
          ...
          {capturedImage && !scanning && faceValidated && (
            <motion.div
              initial={{ opacity: 0, y: 10 }}
              animate={{ opacity: 1, y: 0 }}
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">
                    Facial biomarkers extracted successfully. Proceed to voice
                    scan.
                  </p>
                </div>
              </div>
          ...
          <div className="flex justify-end pt-4">
            <Button
              ...
              onClick={() => {
                stopCamera();
                setLocation("/voice-scan");
              }}
              disabled={!faceValidated}
              title={
                !faceValidated ? "Complete a valid face scan first" : undefined
              }
            >
