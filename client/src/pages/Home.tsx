...
const steps = [
  {
    ...
    title: "Face Scan",
    description:
      "Extracting optical biomarkers via facial landmark analysis, skin pattern detection, and micro-expression mapping.",
  },
  {
    icon: Mic,
    title: "Voice Scan",
    description:
      "Analyzing vocal cord micro-tremors, breathing rhythm, and pitch stability for vocal biomarker extraction.",
  },
  {
    icon: BrainCircuit,
    title: "AI Analysis",
    description:
      "Multi-modal feature fusion through our neural prediction engine with confidence scoring.",
  },
  {
    icon: ActivitySquare,
    title: "Health Insights",
    description:
      "Comprehensive risk analysis dashboard with biomarker panels, feature contribution, and AI recommendations.",
  },
];
...
const features = [
  {
    icon: ShieldCheck,
    title: "Privacy-First",
    desc: "All analysis runs locally. No data stored.",
  },
  {
    icon: Database,
    title: "Research-Backed",
    desc: "Trained on patterns from 7 biomedical datasets.",
  },
  {
    icon: Lock,
    title: "Secure Pipeline",
    desc: "End-to-end encrypted biometric processing.",
  },
];
      ...
      <section className="w-full max-w-7xl mx-auto px-4 py-20 lg:py-32 grid lg:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          <p className="text-xl text-muted-foreground leading-relaxed max-w-xl">
            AI-powered preventive healthcare using face and voice biomarker
            analysis. Detect subtle health changes before symptoms appear.
          </p>
          <div className="flex flex-wrap gap-4 pt-4">
            <Link href="/predict">
              <Button
                size="lg"
                className="h-14 px-8 text-lg rounded-full premium-shadow group"
              >
                Start Prediction
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground">
              Four guided steps to your comprehensive AI health analysis
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {steps.map((step, i) => (
              ...
              >
                ...
                <div className="text-sm font-semibold text-primary/80 mb-2 tracking-wider uppercase">
                  Step {i + 1}
                </div>
